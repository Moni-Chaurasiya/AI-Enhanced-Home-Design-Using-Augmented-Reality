...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new io.carius.lars.ar_flutter_plugin_flutterflow.ArFlutterPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin ar_flutter_plugin_flutterflow, io.carius.lars.ar_flutter_plugin_flutterflow.ArFlutterPlugin", e);
    }
    try {
